...
#show: gost.with(
  ...
  approved-by: (
    name: "Фамилия И.О.",
    position: "Проректор по научной работе и инновациям",
  ),
  ...
  performers: (
    name: "Фамилия И.О.",
    position: "Научн. сотр., канд. пед. наук",
    title: "Заголовок исполнителя,",
  ),
  stage: (type: "заключительный", num: 2),
  part: 1,
  manager: (
    name: "Фамилия И.О.",
    position: "Преподаватель, доцент кафедры 307",
  ),
  city: "Москва",
  year: 2019,
)
