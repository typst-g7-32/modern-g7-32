...
#show: gost.with(
  ...
  approved-by: (name: "Фамилия И.О.", position: "Проректор по научной работе и инновациям"),
  agreed-by: (name: "Фамилия И.О.", position: "Директор ВНИИВСГЭ", year: 2017),
  ...
  performers: (
    (name: "Фамилия И.О.", position: "Научн. сотр., канд. пед. наук"),
  ),
  stage: (type: "заключительный", num: 2),
  part: 1,
  manager: (name: "Фамилия И.О.", position: "Преподаватель, доцент кафедры 307"),
  city: "Москва",
  year: 2019
)